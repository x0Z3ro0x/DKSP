Locales['en'] = {
  ...
  ['spolice_wear'] = 'State Police Outfit',
  ['sheriff_wear'] = 'sheriff Outfit',
  ['lieutenant_wear'] = 'Swatt outfit ',
  ['gilet_wear'] = 'orange reflective jacket',
  ['bullet_wear'] = 'bulletproof vest',
  ['nonvisbullet_wear'] = 'Non-Visable Bulletproof Vest',
  ['no_outfit'] = 'there\'s no uniform that fits you!',
  ['open_cloackroom'] = 'press ~INPUT_CONTEXT~ to change ~y~clothes~s~.',
  -- Armory
  ['remove_object'] = 'On Duty Tools',
  ['deposit_object'] = 'Return On Duty Tools',
  ['get_weapon'] = 'On Duty Weapon\'s',
  ['put_weapon'] = 'Return On Duty Weapon\'s',
  ['buy_weapons'] = 'Buy weapon\'s from Victor Stone!',
  ['buy_items'] = 'Buy items from Victor Stone!',
  ['armory'] = 'State Police Locker',
  ['open_armory'] = 'press ~INPUT_CONTEXT~ to access the State Police Locker',
  -- Vehicles
  ['vehicle_menu'] = 'State Vehicle\'s',
